...
class VanillaRNN(nn.Module):
    ...
    def __init__(self, input_size, hidden_size, output_size):
        ...
        #############################################################################
        self.output_linear = nn.Linear(input_size + hidden_size, output_size)
        self.output_logsoftmax = nn.LogSoftmax()        
    ...
    def forward(self, input, hidden):
        ...
        #############################################################################
        concat_input = torch.cat((input, hidden), 1)
        output = self.output_logsoftmax(self.output_linear(concat_input))
        hidden = self.hidden_tanh(self.hidden_linear(concat_input))        
        #############################################################################
        #                              END OF YOUR CODE                             #
        #############################################################################
